...
SECRET_KEY = 'django-insecure-72wj8=&)9ldqg)f^1xqpiwr(d_b*q+9h_516ja4*4-emkuu@z1'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Tailor App API',
    'DESCRIPTION': 'API for Tailor App including Users, Tailors, Orders, and Reviews.',
    'VERSION': '1.0.0',
